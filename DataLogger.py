...
def DataLogger():
    ...
    while True:
        ...
        last_distance, last_wtemp, last_atemp, last_hum = np.round(logger.collect_data("SensorData", getData(last_distance, last_wtemp, last_hum, last_atemp), last_distance, last_wtemp, last_hum, last_atemp, tsamp=.2, nsamp=5),2)
